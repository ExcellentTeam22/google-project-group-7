...
def read_file(current_file_path: str, word_dict: dict, sentences_dict: dict) -> None:
    with open(current_file_path, encoding="utf8") as current_file:
        ...
        for sentence in sentences:
            ...
            sentences_dict[sentence_id] = (sentence, current_file_path)
    ...
    for root, dirs, files in os.walk(path):
        for file in files:
            if file.endswith('.txt'):
                ...
                read_file(file_path, word_dict, sentences_dict)
    return word_dict, sentences_dict
